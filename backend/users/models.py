...
class Posts(models.Model):
    ...
    text_or_pic=models.BooleanField(default=False)
    picture_url = models.URLField()

    text = models.CharField(max_length=500, null=True)
    font_size = models.CharField(max_length=500, null=True)
    font_color = models.CharField(max_length=500, null=True)
    font_format = models.CharField(max_length=500, null=True)
